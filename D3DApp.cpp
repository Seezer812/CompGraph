...
void D3DApp::InitD3D()
{
    ...
    // Fence ������ ������ � �� ����� ������ BuildTextures/FlushCommandQueue
...
int D3DApp::LoadTextureDDS(const std::wstring& path)
{
    ...
    mTextureUploads.push_back(uploadBuf);  // ������ �� ���������� FlushCommandQueue
